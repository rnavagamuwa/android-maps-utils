...
//                        double weightForCurrentPoint = currentHeatmapPoint.weight;
                        if(intensityForCurrentPoint > 0) {
                            HeatmapPoint newHeatmapPoint = new HeatmapPoint(intensityForCurrentPoint, weightForCurrentPoint);
        ...
        for (i = 0; i < dim; i++) {
            for (j = 0; j < dim; j++) {
                ...
                if (point != null ) {
                    ...
                    if (col < colorMap.length) colors[index] = ColorUtils.setAlphaComponent(fromColorMap, transparency);
    ...
    private class HeatmapPoint {
        ...
        public String toString() {
            return "Intensity: " + intensity + "   Weight: " + weight;
        }
    }
}
